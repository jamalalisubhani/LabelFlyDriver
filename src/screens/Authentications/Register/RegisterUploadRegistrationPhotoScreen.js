...
import { registrationVehicle } from "../../../utils/auth.service";
export default function RegisterUploadRegistrationPhotoScreen({ navigation }) {
  ...
  const next = () => {
    ...
    if (image == "") {
      ...
      console.log("RegisterUploadSelfieScreen");
    } else {
      registrationVehicle(image)
        .then((res) => {
          console.log("==============>>|res", res?.data?.data);
          let newdriver = {
            ...copy_driver,
            vehicle_registration_registration: res?.data?.data,
          };
          if (res?.data?.data) {
            dispatch(setRegisterData({ ...copy, driver: newdriver }));
            navigation.navigate("RegisterUploadSelfieScreen");
          }
        })
        .catch((e) => {
