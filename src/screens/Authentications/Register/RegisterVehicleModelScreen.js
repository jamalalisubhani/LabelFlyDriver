...
import { regStep4 } from "../../../utils/validation";
...
export default function RegisterVehicleModelScreen({ navigation }) {
  ...
  const formik = useFormik({
    validationSchema: regStep4,
    initialValues: {
      model: "",
    },
    onSubmit: async (values) => {
      console.log("hkjhkhkh>>>", values?.model);
  ...
  console.log("formikformik>>", formik?.errors?.model);
  return (
    <ImageBackground
